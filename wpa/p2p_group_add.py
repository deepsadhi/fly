...
def usage():
    ...
    print "  -f = frequency"
    print "  -o = persistant group object path"
...
class P2P_Group_Add(threading.Thread):
    ...
    global persistant
    global frequency
    global persistant_group_obejct
    ...
    # Constructor
    def __init__(self, interface_name, wpas_dbus_interface, persistant, 
                    frequency, persistant_group_object):
        ...
        self.wpas_wpas_dbus_interfaces_opath = self.wpas_dbus_opath + \
            "/Interfaces"
        self.wpas_dbus_interfaces_interfaces = \
            self.wpas_dbus_interface + ".Interface"
        self.wpas_dbus_interfaces_p2pdvice = \
        ...
        self.p2p_interface = dbus.Interface(self.interfaces_object,
                self.wpas_dbus_interfaces_p2pdevice)

        # Adds listeners
        self.bus.add_singal_receiver(GroupStarted,
    ...
    def constructArguements(self):
        ...
        if (self.frequency != None):
            if(int(self.frequency) > 0):
                ...
                print "Error:\n Frequenct muse be greater than 0"
                usage()
                os._exit(0)
    ...
    def run(self):
        ...
        # Allows other threads top keep working while MainLoop runs
...
if __name__ == "__main__":
    ...
    wpas_dbus_interface = 'f1.w1.wpa_supplicant1'
    ...
    try:
        p2p_group_add_test = P2P_Group_Add(interface_namem, wpas_dbus_interfacem
