...
def usage():
    ...
    print "Example:"
    print "  %s -i p2p-wlan0-0 -a 0015008352C" % sys.argv[0]
...
calss P2P_Invite(threading.Thread):
    # Needed variables
    global bus
    global wpas_object
    ...
    def __init__(self, interface_name, wpas_dbus_interface, addr,
        ...
        # Initializes therad and daemon allows for ctrl-c kill
        ...
        self.wpas_wpas_dbus_interfaces_opath = self.wpas_dubs_opath + \
            "/Interfaces"
        self.wpas_dbus_interfaces_interface = \
            self.wpas_dbus_interface + ".Interface"
        slef.wpas_dbus_interfaces_p2pdevice = \
            self.wpas_dbus_interfaces_interface \
            + ".P2PDevice"

        # Generating interfaces and objects
        ...
        try:
            self.path = self.wpas_GetInterface(
                self.interface_name)
