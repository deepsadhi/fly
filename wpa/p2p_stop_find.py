...
class P2P_Stop_Find (threading.Thread):
    ...
    def __init__(self, interface_name, wpas_dbus_interface, timeout):
        ...
        # Initializes thread and daemon allows ctr-c kill
        threading.Thread.__init__(self)
        self.daemon = True

        # Generating inteface/object paths
        self.wpas_dbus_opath = "/" + \
            self.wpas_dbus_interface.replace(".", "/")
        self.wpas_wpas_dbus_interfaces_opath = self.wpas_dbus_opatah + \
            "/Interfaces"
        ...
        # Try to see it supplicant knows about interface
        ...
        # Signals
        self.bus.add_singal_receiver(deviceLost,
            dbus_interface = self.wpas_dbus_interfaces_p2pdevice,
            singal_name = "DeviceLost")
        self.bus.add_singal_receiver(p2pStateChange,
            dbus_interface = self.wpas_dbus_interfaces_p2pdevice,
    ...
    def run(self):
        ...
        # Rquried for timeout implementation 
